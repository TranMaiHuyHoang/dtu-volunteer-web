...
// // File: userMapper.test.js

// // 1. Thay thế CommonJS require() bằng ES Modules import (Giả sử userMapper sử dụng named export)
// import { mapUserData } from '; 
// // Lưu ý: Cần thêm đuôi file (.js) vào đường dẫn import
