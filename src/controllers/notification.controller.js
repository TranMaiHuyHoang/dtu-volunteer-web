// notification.controller.js - SỬ DỤNG ESM

// Thay thế require bằng import (Default Export cho Mongoose Model)
...
const deleteAllNotifications = async (req, res) => {
    try {
        // Lưu ý: Đang sử dụng req.user._id, phải nhất quán với logic JWT (req.user.sub) hoặc Passport (req.user.id)
        // Nếu trước đó bạn dùng req.user.sub, nên dùng lại req.user.sub ở đây.
